...
const int validAnalogUpperRange = 2100; //2.1V upper range
const int validAnalogLowerRange = 1500; //1.5V lower range
...
//Bulb check function. Internal Pull Up, connect switch to ground
void bulbCheck(){
